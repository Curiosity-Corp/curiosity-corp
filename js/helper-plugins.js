...
/* jQuery Parallax (Ian Lunn, 1.1.3) removed — SOP §11: unthrottled,
   non-passive scroll listener that read .offset().top and wrote
   background-position (a paint-triggering, non-compositor property)
   on every scroll tick with no rAF batching. The .parallax base rule
   in css/style.css (background-attachment: fixed, scroll on touch/
   .page-banner) is the retained static/CSS-only fallback — same
   visual result on non-touch viewports, zero JS scroll cost. */
