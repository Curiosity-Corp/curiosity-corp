...
var inputs = document.querySelectorAll("form#volunteerForm input.form-control, textarea, select.form-control");
...
var form = document.querySelector("form#volunteerForm");
...
function showErrors(form, errors) {
    ...
    form.querySelectorAll("#volunteerForm input.form-control, select.form-control, textarea").forEach(function (input) {
...
function resetForm() {
    ...
    document.querySelectorAll('#volunteerForm input.form-control, select.form-control, textarea').forEach(input => {
        input.value = '';
    })
}
...
function showSuccess() {
    grecaptcha.ready(function () {
        grecaptcha.execute("6LcHIYcUAAAAAPnqH0iBwnDeFma0mWAMJKJHAoEO").then(function (token) {
            ...
            var formEl = document.querySelector('form#volunteerForm');
